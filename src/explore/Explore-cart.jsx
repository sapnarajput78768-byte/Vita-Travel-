    ...
    <div className=' flex border border-gray-700 justify-between p-10 pr-16 '>
      <div className='text-white  flex flex-col justify-between'>
        ...
        <div className='text-1xl text-white'>
          ...
          <button  onClick={() => window.location.href = "http://localhost:5173/retreats"} className="  h-7 px-4.5 py-3.5 rounded-2xl bg-gray-600 hover:bg-amber-300   text-1xl font-semibold text-black hover:scale-105 transition flex items-center justify-center">
